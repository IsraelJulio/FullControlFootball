...
public sealed class CreateCompetitionTopAssistsRequestValidator : AbstractValidator<CreateCompetitionTopAssistsRequest>
{
    public CreateCompetitionTopAssistsRequestValidator()
    {
        ...
        RuleForEach(x => x.Rows).ChildRules(row =>
        {
            ...
            row.RuleFor(r => r.Assists).GreaterThanOrEqualTo(0);
        });
    }
}
